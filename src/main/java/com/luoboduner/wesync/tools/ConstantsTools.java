...
public class ConstantsTools {
     ...
     * xpath
     */
    public final static String XPATH_LAST_TIMESTAMP = "//weSync/status/lastTimeStamp";
    public final static String XPATH_BREAKPOINT = "//weSync/status/breakPoint";
     ...
     * 日志文件 路径
     */
    public final static String PATH_LOG = UiConsts.CURRENT_DIR + File.separator + "logs" + File.separator + "WeSync." + (new java.text.SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date()).toString()) + ".log";
}
