 ...
 * @author Bob
 */
public class DbUtilMySQL extends DbUtil {
    ...
    public synchronized Connection getConnection() throws SQLException {
        ...
        if (!ConstantsTools.CONFIGER.getHostTo().equals(DBUrl) || !ConstantsTools.CONFIGER.getNameTo().equals(DBName)
            ...
            connection = DriverManager.getConnection(
                    "jdbc:mysql://" + DBUrl + "/" + DBName + "?useUnicode=true&characterEncoding=utf8&jdbcCompliantTruncation=false&useSSL=true&useServerPrepStmts=false&rewriteBatchedStatements=true&cachePrepStmts=true", user, password);
            // 把事务提交方式改为手工提交
