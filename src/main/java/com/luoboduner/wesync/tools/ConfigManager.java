...
public class ConfigManager {
    ...
    public String getLastTimeStamp() {
        return this.document.selectSingleNode(ConstantsTools.XPATH_LAST_TIMESTAMP).getText();
    }

    public void setLastTimeStamp(String lastTimeStamp) throws Exception {
        this.document.selectSingleNode(ConstantsTools.XPATH_LAST_TIMESTAMP).setText(lastTimeStamp);
        writeToXml();
    }

    public String getBreakPoint() {
        return this.document.selectSingleNode(ConstantsTools.XPATH_BREAKPOINT).getText();
    }

    public void setBreakPoint(String breakPoint) throws Exception {
        this.document.selectSingleNode(ConstantsTools.XPATH_BREAKPOINT).setText(breakPoint);
        writeToXml();
    }
