...
public class DatabasePanelTo extends JPanel {
    ...
    public static void setContent() {
        String typeTo = ConstantsTools.CONFIGER.getTypeTo();
        comboxDatabaseType.setSelectedIndex(typeTo.trim().toUpperCase().equals("MySQL".toUpperCase()) ? 1 : (typeTo.trim().toUpperCase().equals("SQL Server".toUpperCase()) ? 2 : 0));
    ...
    private void addListener() {
        buttonSave.addActionListener(e -> {
            ...
            try {
                ConstantsTools.CONFIGER.setTypeTo(comboxDatabaseType.getSelectedItem().toString());
        ...
        buttonTestLink.addActionListener(e -> {
            ...
            try {
                ...
                Connection conn = dbTo.testConnection(dburl, dbname, dbuser, dbpassword);
                if (conn == null) {
